        ...
        <div class="card">
	       ...
	       <div class="card-body card-block">
                <div class="row form-group">
                   ...
                   <div class="col-12 col-md-9"><input type="text" name="product_title" placeholder="Enter Product Title..." class="form-control"></div>
               </div>
               ...
               <div class="row form-group">
                   ...
                   <div class="col-12 col-md-9"><input type="text" name="tea_name" placeholder="Name of Tea..." class="form-control"></div>
               </div> 
	           ...
	           <div class="row form-group">
	               <div class="col col-md-3"><label for="hf-email" class=" form-control-label">GSTIN</label></div>
	               <div class="col-12 col-md-9"><input type="text" id="hf-email" name="gstin" placeholder="Enter GSTIN..." class="form-control"></div>
	           </div>
