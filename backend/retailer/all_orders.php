                    ...
                    <div class="card-body table-responsive">
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered" style=" overflow: scroll;">
                            ...
                            <tbody>
                                <?php
                                    $count = 1;
                                    $sql_orders = "SELECT * FROM `order_details` WHERE `order_to_id` = '$_SESSION[user_id]'  ORDER BY `order_details_id` DESC";
                                    if ($res_orders = $connection->query($sql_orders)) {
                                        ...
                                        if ($res_product = $connection->query($sql_product)) {
                                            ...
                                            print '<td><img src=../uploads/product_image/'.$product['product_main_image'].' width="100"></td>';
                                        }
