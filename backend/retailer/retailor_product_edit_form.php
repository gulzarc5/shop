	       ...
	       <div class="card-body card-block">
            ...
            ?>
                <div class="row form-group">
                   ...
                   <div class="col-12 col-md-2"><input type="text" name="product_size[]" value="<?php echo $product_size['size']; ?>" placeholder="ex. 12" class="form-control" required></div>
                                ...
                                <?php
                                    ...
                                    if($grade_code_result=$connection->query($grade_code_sql)){
                                        while ($grade_code_row=$grade_code_result->fetch_assoc()) {
                                            if ($product_size['weight_type_id'] == $grade_code_row['weight_type_id']) {
            ...
            ?>
                ...
                <div class="row form-group">
                   ...
                   <div class="col-12 col-md-3"><input type="text" name="weight" placeholder="ex. 12" class="form-control" value="<?php echo $product['weight_per_pack_unit'] ?>" required></div>
                     ...
                     <select name="weight_type"  class="form-control" required id="images_select_box">
                            <option value="" selected>Select Type...</option>
                                <?php
                                    ...
                                    if($grade_code_result=$connection->query($grade_code_sql)){
                                        while ($grade_code_row=$grade_code_result->fetch_assoc()) {
                                            if ($product['weight_per_pack_type_id'] == $grade_code_row['weight_type_id']) {
                                                print"<option value='$grade_code_row[weight_type_id]' selected>$grade_code_row[name] </option>";
                                            }else{
                                                print"<option value='$grade_code_row[weight_type_id]'>$grade_code_row[name] </option>";
                                            }                                            
                ...
                <div class="row form-group">
                   ...
                   <div class="col-12 col-md-3"><input type="text" name="rate" placeholder="ex. 12" class="form-control" value="<?php echo $product['rate'] ?>" required></div>
                   <div class="col-12 col-md-6" >

                     <select name="rate_currency"  class="form-control" required id="images_select_box">
                            <option value="" selected>Select Currency...</option>
                            <?php 
                                if ($product['rate_currency'] == 1) {
                                   print "<option value='1' selected>INR</option>
                                    <option value='2'>USD</option>  ";
                                }elseif ($product['rate_currency'] == 2) {
                                    print "<option value='1'>INR</option>
               ...
               <div class="row form-group">
                   ...
                   <div class="col-12 col-md-3"><input type="text" name="min_order" placeholder="ex. 12" class="form-control" value="<?php echo $product['min_order_unit']?>" required></div>
                   <div class="col-12 col-md-6" >
                     ...
                     <select name="min_order_unit"  class="form-control" required id="images_select_box">
                            <option value="" selected>Select Unit...</option>
                                <?php
                                    ...
                                    if($grade_code_result=$connection->query($grade_code_sql)){
                                        while ($grade_code_row=$grade_code_result->fetch_assoc()) {
                                            if ($product['min_order_type_id'] == $grade_code_row['weight_type_id']) {
                                               print"<option value='$grade_code_row[weight_type_id]' selected>$grade_code_row[name] </option>";
                                            }else{
                                                print"<option value='$grade_code_row[weight_type_id]'>$grade_code_row[name] </option>";
                                            }
