...
<div class="col-lg-6">
    <div class="card">
        ...
        ?>   
        <form action="serverScripts/add_wseller_bank.php" method="post" class="form-horizontal">
                        ...
                        <table id="region_table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="wseller_bank_edit_form.php?id=<?php echo $bank_data['user_bank_id'];?>">
                                        <button type="submit" name="add_retailer_bank"  class="btn btn-primary btn-sm">
                                            <i class="fa fa-dot-circle-o"></i> Edit
                                        </button>
                                        </a>
                                        <a  href="serverScripts/wseller_bank_delete.php?id=<?php echo $bank_data['user_bank_id'];?>">
